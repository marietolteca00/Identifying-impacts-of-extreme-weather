...
ggsave(filename = here("images", "vnp_16_after.png"), plot = vnp_16, width = 8, height = 6, units = "in", dpi = 300)
```
...
When the Texas storm hit in February 2023, the analysis suggests that most areas experiencing blackouts were concentrated near major highways and in central Houston, where warehouses or industrial zones may be located. This pattern indicates that infrastructure and land use type could have influenced which areas lost power. One limitation of this study is that we did not distinguish buildings by usage (ex.residential vs. commercial). Including socioeconomic variables, such as poverty levels could provide a clearer understanding of which communities were most affected and whether vulnerable populations experienced disproportionate impacts.
