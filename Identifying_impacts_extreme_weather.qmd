...
tm_shape(blackout_houston_proj) +
  ...
  tm_borders(col = "hotpink")+
  # FIX
  tm_legend(title = "Highway Buffer of 200 (m)")
...
# Checking CRS
if(st_crs(highway_blackouts) == st_crs(homes)){
  print("Extents match :)")
}  else{
  print("extents do not match :(")
}
...
# Overlaps
building_overlap <- st_intersection(buildings, highway_blackouts)
